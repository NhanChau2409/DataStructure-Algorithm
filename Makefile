#############################################################################
# Makefile for building: prg1.app/Contents/MacOS/prg1
# Generated by qmake (3.1) (Qt 6.4.0)
# Project:  prg1.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile prg1.pro
#############################################################################
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -Wall -Wextra -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk/System/Library/Frameworks/AGL.framework/Headers -I/usr/local/share/qt/mkspecs/macx-clang -F/usr/local/lib
...
COMPRESS      = gzip -9f
DISTNAME      = prg11.0.0
DISTDIR = /Users/nhanchau/Documents/TUNI/D&A/vpnhch/prg1/.tmp/prg11.0.0
LINK          = /Library/Developer/CommandLineTools/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/clang-mac.conf \
...
QMAKE_TARGET  = prg1
DESTDIR       = 
TARGET        = prg1.app/Contents/MacOS/prg1

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 12.3
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/nhanchau/Documents/TUNI/D&A/vpnhch/prg1/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/nhanchau/Documents/TUNI/D&A/vpnhch/prg1/prg1.pro


include /usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

prg1.app/Contents/MacOS/prg1: ui_mainwindow.h $(OBJECTS)  
	@test -d prg1.app/Contents/MacOS/ || mkdir -p prg1.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: prg1.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/macx.conf \
...
prg1.app/Contents/PkgInfo: 
	@test -d prg1.app/Contents || mkdir -p prg1.app/Contents
	@$(DEL_FILE) prg1.app/Contents/PkgInfo
	@echo "APPL????" > prg1.app/Contents/PkgInfo
prg1.app/Contents/Resources/empty.lproj: 
	@test -d prg1.app/Contents/Resources || mkdir -p prg1.app/Contents/Resources
	@touch prg1.app/Contents/Resources/empty.lproj
	
prg1.app/Contents/Info.plist: 
	@test -d prg1.app/Contents || mkdir -p prg1.app/Contents
	@$(DEL_FILE) prg1.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.prg1,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.prg1,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,prg1,g" -e "s,@LIBRARY@,prg1,g" -e "s,\$${EXECUTABLE_NAME},prg1,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >prg1.app/Contents/Info.plist

all: Makefile \
		prg1.app/Contents/PkgInfo \
		prg1.app/Contents/Resources/empty.lproj \
		prg1.app/Contents/Info.plist prg1.app/Contents/MacOS/prg1
...
moc_predefs.h: /usr/local/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -Wall -Wextra -fPIC -dM -E -o moc_predefs.h /usr/local/share/qt/mkspecs/features/data/dummy.cpp
...
moc_mainwindow.cpp: mainwindow.hh \
	...
	/usr/local/share/qt/libexec/moc $(DEFINES) --include '/Users/nhanchau/Documents/TUNI/D&A/vpnhch/prg1/moc_predefs.h' -I/usr/local/share/qt/mkspecs/macx-clang -I'/Users/nhanchau/Documents/TUNI/D&A/vpnhch/prg1' -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/13.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX12.3.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/usr/local/lib mainwindow.hh -o moc_mainwindow.cpp
