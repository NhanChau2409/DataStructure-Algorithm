...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        stations_checkbox->setObjectName("stations_checkbox");
        ...
        stationnames_checkbox->setObjectName("stationnames_checkbox");
